...
const int ADCL_attr_ialltoall_alg_linear_sr=100;
const int ADCL_attr_ialltoall_alg_linear_sync_sr=101;
const int ADCL_attr_ialltoall_alg_ladd_block2=102;
const int ADCL_attr_ialltoall_alg_ladd_block4=103;
const int ADCL_attr_ialltoall_alg_ladd_block8=104;
const int ADCL_attr_ialltoall_alg_pairwise_sr=105;
const int ADCL_attr_ialltoall_alg_pairwise_excl_sr=106;
const int ADCL_attr_ialltoall_alg_linear=107;
const int ADCL_attr_ialltoall_alg_pairwise=108;
const int ADCL_attr_ialltoall_alg_diss=109;
...
int ADCL_predefined_ialltoall ( void )
{
    ...
    char * ADCL_attr_ialltoall_alg_names[ADCL_ATTR_IALLTOALL_ALG_MAX] = {"Ialltoall_linear_sr","Ialltoall_linear_sync_sr","Ialltoall_ladd_block2","Ialltoall_ladd_block4","Ialltoall_ladd_block8","Ialltoall_pairwise_sr","Ialltoall_pairwise_excl_sr","Ialltoall_linear","Ialltoall_pairwise","Ialltoall_diss"};
    char * ADCL_attr_ialltoall_depth_names[ADCL_ATTR_IALLTOALL_DEPTH_MAX] = {"0 (none)","1","2","3","4","5"};

    ADCL_attr_ialltoall_alg[0] = ADCL_attr_ialltoall_alg_linear_sr;
    ADCL_attr_ialltoall_alg[1] = ADCL_attr_ialltoall_alg_linear_sync_sr;
    ADCL_attr_ialltoall_alg[2] = ADCL_attr_ialltoall_alg_ladd_block2;
    ADCL_attr_ialltoall_alg[3] = ADCL_attr_ialltoall_alg_ladd_block4;
    ADCL_attr_ialltoall_alg[4] = ADCL_attr_ialltoall_alg_ladd_block8;
    ADCL_attr_ialltoall_alg[5] = ADCL_attr_ialltoall_alg_pairwise_sr;
    ADCL_attr_ialltoall_alg[6] = ADCL_attr_ialltoall_alg_pairwise_excl_sr;
    ADCL_attr_ialltoall_alg[7] = ADCL_attr_ialltoall_alg_linear;
    ADCL_attr_ialltoall_alg[8] = ADCL_attr_ialltoall_alg_pairwise;
    ADCL_attr_ialltoall_alg[9] = ADCL_attr_ialltoall_alg_diss;
...
// Blocking linear
#if 1
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear_sr;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear_sync_sr;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_ladd_block2;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_ladd_block4;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_ladd_block8;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
...
// Blocking pairwise
#if 1
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_pairwise_sr;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_pairwise_excl_sr;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_0;
...
// Non-blocking linear
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_1;
    ADCL_function_create_async ( ADCL_ialltoall_linear, ADCL_ialltoall_wait, ADCL_ialltoall_attrset,
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_2;
    ADCL_function_create_async ( ADCL_ialltoall_linear, ADCL_ialltoall_wait, ADCL_ialltoall_attrset,
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_3;
    ADCL_function_create_async ( ADCL_ialltoall_linear, ADCL_ialltoall_wait, ADCL_ialltoall_attrset,
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_4;
    ADCL_function_create_async ( ADCL_ialltoall_linear, ADCL_ialltoall_wait, ADCL_ialltoall_attrset,
    ...
    m_ialltoall_attrs[0] = ADCL_attr_ialltoall_alg_linear;
    m_ialltoall_attrs[1] = ADCL_attr_ialltoall_depth_5;
    ADCL_function_create_async ( ADCL_ialltoall_linear, ADCL_ialltoall_wait, ADCL_ialltoall_attrset,
