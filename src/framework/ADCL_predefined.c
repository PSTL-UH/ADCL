...
extern ADCL_fnctset_t *ADCL_iallgather_fnctset;
extern ADCL_fnctset_t *ADCL_ireduce_fnctset;
#endif
...
int ADCL_predefined_finalize ( void )
{
    ...
    ADCL_Fnctset_free ( &ADCL_iallgather_fnctset );
    ADCL_Fnctset_free ( &ADCL_ireduce_fnctset );
#endif
