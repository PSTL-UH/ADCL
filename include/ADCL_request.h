...
#ifdef ADCL_LIBNBC
struct ADCL_Ibcast_args_t;
struct ADCL_Ialltoall_args_t;
struct ADCL_Iallgather_args_t;
struct ADCL_Ireduce_args_t;
#endif
...
struct ADCL_request_s{
   ...
   int                      r_progress;
#endif
   ADCL_Ibcast_args_t         *r_Ibcast_args;
   ADCL_Ialltoall_args_t      *r_Ialltoall_args;
   ADCL_Iallgather_args_t     *r_Iallgather_args;
   ADCL_Ireduce_args_t     *r_Ireduce_args;
#endif
  /* flag to know if the request was generated by an ADCL high level interface */
   int                      r_highlevel;
   ADCL_Highlevel           r_Highlevel;
};
