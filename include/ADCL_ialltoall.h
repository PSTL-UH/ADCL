...
//#define ADCL_METHOD_IALLTOALL_TOTAL_NUM  11
    ...
    #define ADCL_METHOD_IALLTOALL_TOTAL_NUM  26
#else
    #define ADCL_METHOD_IALLTOALL_TOTAL_NUM  20
#endif
