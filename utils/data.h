...
extern int _rows;
extern int _columns;
extern double* _geneweight;
extern double* _arrayweight;
extern double* _geneorder;  /* Saves gene order in the data file */
extern double* _arrayorder; /* Saves array order in the data file */
extern int* _geneindex;   /* Set by clustering methods for file output */
extern int* _arrayindex;  /* Set by clustering methods for file output */
extern char* _uniqID;     /* Stores UNIQID identifier in the data file */
extern char** _geneuniqID;
extern char** _genename;
...
int signum(int x);
char* MakeID (const char* name, int i);
void TreeSort(const char which, const int nNodes, const double* order,
