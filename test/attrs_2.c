...
/* Same test as attrs_1, however, should not lead to 
 a unique winner from the attribute perspective */
...
int main ( int argc, char ** argv ) 
{
    ...
    ADCL_Fnctset_create ( 18, funcs, "trivial functions", NULL, &fnctset );
